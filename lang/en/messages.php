    ...
    */
    'validation' =>[
        'success' =>[
            ...
            'updated_records' => ':count rescords have been updated',
            'job_retry' => 'the job successfully retried'
        ],
        'fail' =>[
            ...
            'somthing_went_wrong' => 'somthing went wrong try later or contact support',
            'job_retry' => 'the job faild to retried'
        ...
        'not_allow' => [
            ...
            'level_finish_in_progress' => 'the level is being finished already',
            'level_activate_previous_not_audit' => 'you cant activate level before audit the previous level responses',
            'auto_audit_still_early' => 'you can not auto confirm responses that generated by AI, until the audit time pass wait :minutes minutes',
            're_assing_users_to_level_creator' => 'you can\'t re assing users rtesponses that not audited yet until the audit time pass wait :minutes',
            ...
            'competition_create_less_gift' => 'You cannot create a competition with a winner gift less :gift.',
            'service_insufficient_balance' => 'You do not have sufficient balance to proceed this action.',
