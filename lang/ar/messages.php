    ...
    */
    'validation' =>[
        'success' =>[
            ...
            'updated_records' => ':count سجل تم تعديله',
            'job_retry' => 'تم اعادة المهمة بنجاح',
        ...
        'info' => [
            ...
            'nothing_to_update' => 'لا يوجد سجلات لتعديلها',
        ...
        'not_allow' => [
            ...
            'level_finish_in_progress' => 'جاري انهاء المرحلة بالفعل',
            'level_activate_previous_not_audit' => 'لا يمكن تفعيل مرحلة قبل تصحيح اجابات المرحلة السابقة',
            'auto_audit_still_early' => 'لا يمكنك بدء التأكيد التلقائي للاجابات المصححة ب AI حتى تنتهي فترة التقييم الممنوحة للمصحيحن بعد :minutes دقيقة',
            're_assing_users_to_level_creator' => 'لا يمكنك  إعادة اسناد اجابات المستخدمين التي لم تدقق بعد  حتى تنتهي فترة التقييم الممنوحة للمصحيحن بعد :minutes دقيقة',
            ...
            'competition_create_less_gift' => 'الهدية المطلوبة للمسابقة أقل من  :gift',
            'service_insufficient_balance' => 'ليس لديك رصيد كافي لتنفيذ هذا الإجراء.',
        ],
